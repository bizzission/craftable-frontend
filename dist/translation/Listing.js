...
var _BaseListing = _interopRequireDefault(require("../base-components/Listing/BaseListing"));
...
_vue["default"].component('translation-listing', {
  mixins: [_BaseListing["default"]],
  props: {
    label: {
      type: String,
  ...
  methods: {
    ...
    beforeModalOpen: function beforeModalOpen(_ref) {
      ...
      for (var _i = 0, _Object$keys = Object.keys(params.text); _i < _Object$keys.length; _i++) {
    ...
    onSubmit: function onSubmit() {
      ...
      axios.post(url, data).then(function (response) {
        ...
        _this4.$notify({
          type: 'success',
          title: 'Success!',
          text: 'Item successfully changed.'
        });
